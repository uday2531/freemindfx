 ...
 *         {@link plugins.map.MapMarkerLocation} here. The position, the position of the map
...
public class FreeMindMapController extends JMapController implements
    ...
    protected static java.util.logging.Logger logger = Resources
...
//		Tools.addFocusPrintTimer();
    ...
    /**
     * @param pTileSource
     * @param pMap        if found, the map tile source is set. Set null, if you don't
     *                    want this.
     ...
     * are:
     * <ul>
     * <li>{@link java.awt.event.MouseEvent#BUTTON1} (left mouse button)</li>
     * <li>{@link java.awt.event.MouseEvent#BUTTON2} (middle mouse button)</li>
     * <li>{@link java.awt.event.MouseEvent#BUTTON3} (right mouse button)</li>
     * </ul>
     *
