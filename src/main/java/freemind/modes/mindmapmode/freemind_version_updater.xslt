...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                xmlns:HtmlTools="xalan://freemind.main.HtmlTools" exclude-result-prefixes="HtmlTools">
    ...
    <xsl:template match="node">
        ...
        <xsl:copy>
            <xsl:choose>
                ...
                <xsl:when
                        test="$version &lt; 0800300 and hook[@NAME='accessories/plugins/CreationModificationPlugin.properties']">
                                ...
                                <p>
                                    <xsl:call-template name="br-replace">
                                        <xsl:with-param name="input">
                                            <xsl:value-of
                                                    select="HtmlTools:replaceSpacesToNonbreakableSpaces(string(hook[@NAME='accessories/plugins/NodeNote.properties']/text))"/>
