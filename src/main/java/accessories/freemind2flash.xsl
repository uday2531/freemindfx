        ...
        <html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
            <head>
                ...
                <xsl:element name="script">
                    ...
                    <xsl:attribute name="src">./<xsl:value-of select="$destination_dir"/>flashobject.js
                    </xsl:attribute>
                    <xsl:text></xsl:text>
                    <!-- this space is a trick, such that firefox displays the flash...  :( -->
                </xsl:element>
                <style type="text/css">
            ...
            <body>
                ...
                <script type="text/javascript">
                    var fo = new FlashObject("./<xsl:value-of select="$destination_dir"/>visorFreemind.swf",
                    "visorFreeMind", "100%", "100%", 8, "#9999ff");
