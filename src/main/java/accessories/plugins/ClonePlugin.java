...
public class ClonePlugin extends PermanentMindMapNodeHookAdapter implements
    ...
    /**
     * This is the master list. {@link accessories.plugins.ClonePlugin#mCloneNodes mCloneNodes} is
     ...
     * belonging to the {@link accessories.plugins.ClonePlugin#mCloneNodeIds mCloneNodeIds}.
     */
    ...
    /**
     * @return a list of {@link freemind.modes.MindMapNode}s including the original node!
     */
