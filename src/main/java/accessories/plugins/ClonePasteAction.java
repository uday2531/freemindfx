...
public class ClonePasteAction extends MindMapNodeHookAdapter {
    ...
    public static class Registration implements HookRegistration,
        ...
        /**
         * Mapping of clone id (String) to a HashSet of {@link freemind.modes.MindMapNode}s
         */
        private HashMap mCloneIdsMap = new HashMap();
        /**
         * This is the reverse of mCloneIdsMap: {@link freemind.modes.MindMapNode} to cloneId.
         */
         ...
         *
         * @param pNode            is checked to be son of one of the clones/original.
         * @param pStartWithParent Sometimes, it is relevant, if only one of the parents is a
         ...
         * @return a list of {@link freemind.main.Tools.MindMapNodePair}s where the first is the
        ...
        public List getCorrespondingNodes(MindMapNode pNode,
            ...
            CloneLoop:
            for (Iterator itClone = targets.iterator(); itClone
                    .hasNext(); ) {
