...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/">
        ...
        <xsl:processing-instruction name="xml-stylesheet">href="treestyles.css" type="text/css"
            ...
            <head>
                ...
                <xsl:element name="link">
                    ...
                    <xsl:attribute name="href">
                        <xsl:value-of select="$destination_dir"/>treestyles.css
                    </xsl:attribute>
                ...
                <xsl:element name="script">
                    ...
                    <xsl:attribute name="src">
                        <xsl:value-of select="$destination_dir"/>marktree.js
                    </xsl:attribute>
                    &#160;
                </xsl:element>
            </head>
    ...
    <xsl:template name="listnode">
        ...
        <!-- adds a line-break in the html code -->
        <li class="{$lifold}">
            <xsl:if test="cloud/@COLOR">
                <xsl:attribute name="style">background-color:<xsl:value-of select="cloud/@COLOR"/>;
                </xsl:attribute>
            </xsl:if>
